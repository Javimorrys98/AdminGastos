...
watch(gastos, () => {
	gastado.value = gastos.value.reduce((gastoTotal, gasto) => gastoTotal + gasto.cantidad, 0);
...
<template>
	<div :class="{ fijar: modal.mostrar }">
		...
		<main v-if="presupuesto > 0">
			...
			<Modal v-if="modal.mostrar" @ocultar-modal="ocultarModal" @guardar-gasto="guardarGasto" @eliminar-gasto="eliminarGasto" :modal="modal"
